...
## Update 2026-09-19 — integration arc (coffea / fastjet / conda): graphed side SHIPPED; fastjet#401 + uproot5#1720 in upstream review
...
- **Forks (review loops closed):** uproot `~/vibe-coding/uproot5-graphed-form-mapping` @ `graphed-form-mapping` 6bdc948 = FOLDED into scikit-hep/uproot5#1720 (owner 2026-09-19; ff push to `graphed-org:graphed-mvp`, description + comment updated); fastjet `~/vibe-coding/fastjet-graphed-mvp` @ `graphed-arm` f7d5d55 = **scikit-hep/fastjet#401 OPEN** (rebased on merged #400; docs example fixed); coffea `~/vibe-coding/coffea-graphed-mvp` @ `graphed-mvp` 9c6cace8 LOCAL ← a uproot release carrying #1720, then raise coffea's uproot floor and open upstream (A1).
...
- Awaiting others: conda-forge reviewers on #34887 (CI green at 0.0.3); uproot5#1720 review; fastjet#401 review + CI. Owner confirmations outstanding: fastjet arm REFUSES flat single-event input; coffea arm has no `.graphed` descriptor slot.
