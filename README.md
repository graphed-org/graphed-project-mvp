...
| **M37** | ✅ DONE | graphed-core-mvp, graphed-exec-local-mvp, graphed-debug-mvp | Live execution dashboard: passive Monitor seam (graphed-core), executor emit (graphed-exec-local: Thread/Process monitor= + cross-process collector), and an opt-in Dashboard + SSE + vendored static SPA (uPlot/d3-flame-graph) + pyinstrument sampler (graphed-debug). Determinism gate green attached-or-not. Root prompt R20. |
...
| [graphed-debug-mvp](https://github.com/graphed-org/graphed-debug-mvp) | M6 debug/tracebacks | `932b2ec` | ✅ submodule |
| [graphed-exec-local-mvp](https://github.com/graphed-org/graphed-exec-local-mvp) | M7 reference executor | `0ab6753` | ✅ submodule |
...
<sub>Generated from <code>.graphed/state.json</code> (updated 2026-06-13T23:05:56Z).</sub>
