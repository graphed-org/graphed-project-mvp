...
| [graphed-exec-local-mvp](https://github.com/graphed-org/graphed-exec-local-mvp) | M7 reference executor | `b88e7b8` | ✅ submodule |
...
<sub>Generated from <code>.graphed/state.json</code> (updated 2026-06-16T22:36:00Z).</sub>
