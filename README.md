...
| [graphed-exec-local-mvp](https://github.com/graphed-org/graphed-exec-local-mvp) | M7 reference executor | `12b5639` | ✅ submodule |
...
<sub>Generated from <code>.graphed/state.json</code> (updated 2026-06-17T19:35:26Z).</sub>
