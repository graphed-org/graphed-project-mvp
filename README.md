...
| [graphed-debug-mvp](https://github.com/graphed-org/graphed-debug-mvp) | M6 debug/tracebacks | `82ff558` | ✅ submodule |
| [graphed-exec-local-mvp](https://github.com/graphed-org/graphed-exec-local-mvp) | M7 reference executor | `8c25d3b` | ✅ submodule |
...
<sub>Generated from <code>.graphed/state.json</code> (updated 2026-06-16T02:08:19Z).</sub>
