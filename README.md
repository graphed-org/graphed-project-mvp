...
| [graphed-exec-local-mvp](https://github.com/graphed-org/graphed-exec-local-mvp) | M7 reference executor | `998db3a` | ✅ submodule |
...
<sub>Generated from <code>.graphed/state.json</code> (updated 2026-06-17T02:09:42Z).</sub>
