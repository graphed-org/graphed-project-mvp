...
**54 of 54 milestones DONE — all CI-green on the §A.5 matrix.** Current milestone: **m58**.
...
| [graphed](https://github.com/graphed-org/graphed) | consolidated package: frontend + core (Rust IR/optimizer) + awkward + numpy + debug + checkpoint + preserve | `6464a3a` | ✅ submodule |
| [graphed-corpus-mvp](https://github.com/graphed-org/graphed-corpus-mvp) | M0.5 requirements + fixtures | `b14d145` | ✅ submodule |
| [graphed-executors](https://github.com/graphed-org/graphed-executors) | graphed-executors: reference + dask + parsl executors, shuffle/join data plane | `3afd1cf` | ✅ submodule |
| [graphed-histogram](https://github.com/graphed-org/graphed-histogram) | histogram filling (M23/M29) + systematics-vary sink variation axis (M48-M51) | `0b01391` | ✅ submodule |
...
<sub>Generated from <code>.graphed/state.json</code> (updated 2026-09-18T22:06:55Z).</sub>
