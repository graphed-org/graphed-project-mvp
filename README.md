...
| [graphed-exec-local-mvp](https://github.com/graphed-org/graphed-exec-local-mvp) | M7 reference executor | `eca9794` | ✅ submodule |
...
<sub>Generated from <code>.graphed/state.json</code> (updated 2026-06-17T13:35:23Z).</sub>
