...
| [graphed-exec-local-mvp](https://github.com/graphed-org/graphed-exec-local-mvp) | M7 reference executor | `19183d9` | ✅ submodule |
...
<sub>Generated from <code>.graphed/state.json</code> (updated 2026-06-17T12:13:24Z).</sub>
