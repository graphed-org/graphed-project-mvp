...
| [graphed-exec-local-mvp](https://github.com/graphed-org/graphed-exec-local-mvp) | M7 reference executor | `4e04240` | ✅ submodule |
...
<sub>Generated from <code>.graphed/state.json</code> (updated 2026-06-17T02:49:39Z).</sub>
