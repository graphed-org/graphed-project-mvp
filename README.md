...
| [graphed-exec-local-mvp](https://github.com/graphed-org/graphed-exec-local-mvp) | M7 reference executor | `1e0d3af` | ✅ submodule |
...
<sub>Generated from <code>.graphed/state.json</code> (updated 2026-06-16T22:22:29Z).</sub>
